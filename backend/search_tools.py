...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course outline: title, course link, and ordered lesson list"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: course title, course link, and complete lesson list with lesson numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
